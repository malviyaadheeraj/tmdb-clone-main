...
const Login = () => {
  ...
  return (
    <>
      <Header />
      <div className="login">
        <h2 className="loginTitle">Login to your accouunt</h2>
        <p>
          ...
          free and simple. &nbsp;<Link className="loginLink">Click here</Link>{" "}
          to get started.
        </p>
        <p>
          If you signed up but didn't get your verification email,&nbsp;&nbsp;
          <Link className="loginLink">Click here</Link> to have it resent.
        </p>
